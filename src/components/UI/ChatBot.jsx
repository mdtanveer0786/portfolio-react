...
const ChatBot = () => {
    ...
    return (
        ...
        <motion.a
            ...
            className="fixed bottom-4 left-4 sm:bottom-8 sm:left-8 z-[9999] w-11 h-11 sm:w-12 sm:h-12 rounded-full bg-[#25D366] flex items-center justify-center shadow-[0_6px_20px_rgba(37,211,102,0.4)] hover:shadow-[0_8px_30px_rgba(37,211,102,0.6)] transition-shadow duration-300 group"
        >
